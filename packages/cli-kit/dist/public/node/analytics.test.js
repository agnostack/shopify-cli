...
import { analyticsDisabled, ciPlatform, cloudEnvironment, isDevelopment, isShopify, isUnitTest, macAddress, } from './context/local.js';
...
describe('event tracking', () => {
    ...
    async function inProjectWithFile(file, execute) {
