...
describe('monorail', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(http.fetch).mockResolvedValue({ status: 200 });
    });
    afterEach(() => {
        vi.useRealTimers();
    });
    test('shows an error if the Monorail request fails', async () => {
        vi.mocked(http.fetch).mockResolvedValueOnce({ status: 500, statusText: 'Monorail is down' });
...
//# sourceMappingURL=monorail.test.js.map